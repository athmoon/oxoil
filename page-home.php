<?php
	...
	*/
	...
	$featuredProducts = htmlentities( json_encode( get_field('product_features') )  );
?>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="well well-main" style="min-height: 300px;">
					...
					<div class="row" ng-controller="FeatureProductsController" ng-init='featureProducts = "Asshurim" '>
